...
export class GitGraphView {
  ...
  private constructor(
    ...
    this.repoManager.registerViewCallback(
      (repos: GitRepoSet, numRepos: number, loadRepo: string | null) => {
      ...
      async (msg: RequestMessage) => {
        ...
        switch (msg.command) {
          case 'addTag':
            this.sendMessage({
              command: 'addTag',
              error: await this.dataSource.addTag(
                msg.repo,
                msg.tagName,
                msg.commitHash,
                msg.lightweight,
          ...
          case 'checkoutBranch':
            this.sendMessage({
              ...
              error: await this.dataSource.checkoutBranch(
                msg.repo,
                msg.branchName,
                msg.remoteBranch,
              ),
          ...
          case 'cherrypickCommit':
            this.sendMessage({
              ...
              error: await this.dataSource.cherrypickCommit(
                msg.repo,
                msg.commitHash,
                msg.parentIndex,
              ),
          ...
          case 'changeRemoteUrl':
            this.sendMessage({
              ...
              error: await this.dataSource.changeRemoteUrl(msg.repo, msg.remoteUrl),
            })
            break
          case 'fetchAvatar':
          ...
          case 'mergeBranch':
            this.sendMessage({
              command: 'mergeBranch',
              error: await this.dataSource.mergeBranch(
                msg.repo,
                msg.branchName,
                msg.createNewCommit,
                msg.squash,
          ...
          case 'mergeCommit':
            this.sendMessage({
              command: 'mergeCommit',
              error: await this.dataSource.mergeCommit(
                msg.repo,
                msg.commitHash,
                msg.createNewCommit,
                msg.squash,
          ...
          case 'pushBranch':
            this.sendMessage({
              command: 'pushBranch',
              error: await this.dataSource.pushBranch(
                msg.repo,
                msg.branchName,
                msg.remote,
                msg.setUpstream,
          ...
          case 'rebaseOn':
            this.sendMessage({
              ...
              error: await this.dataSource.rebaseOn(
                msg.repo,
                msg.base,
                msg.type,
                msg.ignoreDate,
    ...
    if (numRepos > 0) {
      body = `<body style="${colorVars}">
          ...
          <div id="settingsContainer">
            <div id="settingsBtn" title="repository remote(s) config"></div>
            <ul class="dropdown-menu">
              <li id="remoteUrl">Change remote url</li>
            </ul>
          </div>
